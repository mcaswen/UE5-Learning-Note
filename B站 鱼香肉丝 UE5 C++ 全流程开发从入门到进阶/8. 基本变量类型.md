...
- ​**​使用场景​**​：
    ...
    //从其他两种字符串转入方法: ToString()
    MyName.ToString(); // FName转入
    MyText.ToString(); // FText转入
...
- ​**​使用场景​**​：
    ...
    //从其他两种字符串转入方法：FName()构造，且FText需先转FString再转FName
    FName(*MyString) //FString转入
    FName(*MyText.ToString()); //FText转入
    ```
...
- ​**​使用场景​**​：
    ...
    //从其他两种字符串转入方法：FText::Fromxxx()方法
    FText::FromString(MyString); //FString转入
    FText::FromName(MyName); //FText转入
    ```
